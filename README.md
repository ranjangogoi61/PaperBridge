...
## Setup
## Open index.html — no build step, no dependencies beyond the Tesseract.js CDN script (loaded automatically). Deployed live at:  https://paper-bridge-oo49.vercel.app
## Demo
[video link here — https://youtube.com/shorts/YLruJxnyrJU
note: video shows only the original PAN Application flow; see note above]
